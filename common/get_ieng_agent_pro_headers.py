...
def get_ieng_agent_pro_headers(openid):
    # 以下数据获取《IENG公众号》的MELEDEV
    method = 'POST'
    url = 'https://wxagent.tope365.com/agent/login'
    headers = {}
...
if __name__ == "__main__":
    ...
    data = {"loginName": "zongdaili", "password": "654321"}
    ieng_token = get_ieng_agent_pro_headers(data)
    print(ieng_token)
