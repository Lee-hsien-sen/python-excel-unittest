...
def get_ieng_wx_teacher_headers(data):
    # 以下数据获取《IENG公众号》的MELEDEV
    method = 'POST'
    url = 'https://test.tope365.com/teacher/login'
    headers = {}
...
if __name__ == "__main__":
    ...
    data = {"loginName": "gjntest", "password": "123456"}
    ieng_token = get_ieng_wx_teacher_headers(data)
    print(ieng_token)
