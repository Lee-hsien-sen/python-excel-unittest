...
def get_ieng_headers(data):
    ...
    url = 'https://readapp.tope365.com/engApi/login'
    headers={}
...
if __name__ == "__main__":
    ...
    #     "isForce": "0"
    # }
    data = {"loginName":"shangbin",
            "deviceNumber":"0123456789ABCDEF86938302021611500:92:fa:08:ed:e7",
            "appVersion":"3.9.7.190128",
            "password":"E10ADC3949BA59ABBE56E057F20F883E",
            "deviceName":"alps/full_l805b_f_tpad_sy/l805b_f_tpad_sy:5.1/LMY47D/1548053023:userdebug/test-keys",
            "isForce":"1"}
